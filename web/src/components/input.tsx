...
export function InputIcon(props: InputIconProps) {
  return (
    <span
      className="text-gray-400 group-focus-within:text-gray-100 group-[&:not(:has(input:placeholder-shown))]:text-gray-100 group-data-[error=true]:text-danger group-data-[error=true]:group-[&:not(:has(input:placeholder-shown))]:text-danger"
      {...props}
    />
  )
}
